...
window.onload = () => {
    ...
    switch (window.location.hostname) {
        ...
        case '10.42.14.164': serverName = 'Public Server'; break;
    }
...
const gameDrawBanned = (() => {
    ...
    return () => {
        clearScreen(mixColors(color.red, color.guiblack, 0.3), 0.25);
        text.disconnected.draw('💀 You were banned from the game. 💀', global.screenWidth / 2, global.screenHeight / 2, 30, color.guiwhite, 'center');
        text.message.draw(global.message, global.screenWidth / 2, global.screenHeight / 2 + 30, 15, color.orange, 'center');
    };
})();
...
},{"./canvas":2,"./lib/fasttalk":3,"./lib/global":4,"./lib/util":5}],2:[function(require,module,exports){
var global = require('./lib/global');
...
},{"./lib/global":4}],3:[function(require,module,exports){
/*jslint esversion: 6*/
